...
![1575429326515](图片/1575429326515.png) 
...
![1552145659243](图片/1552145659243.png)

发现收到错误响应：

![1552145695272](图片/1552145695272.png)
...
![1575430521729](图片/1575430521729.png) 
...
![1578445546507](图片/1578445546507.png) 
...
![1575431681811](图片/1575431681811.png) 
...
![1575431894292](图片/1575431894292.png) 
...
![1575439951112](图片/1575439951112.png) 

点击链接，去到对象存储页面：

![1575440028426](图片/1575440028426.png) 
...
![1575440350543](图片/1575440350543.png) 

开通后，即可以进入管理控制台：

![1575440806451](图片/1575440806451.png) 
...
![1575441974929](图片/1575441974929.png) 

点击后，弹出对话框，填写基本信息：

![1575442212986](图片/1575442212986.png) 
...
![1575444412056](图片/1575444412056.png)

 

![1578449372530](图片/1578449372530.png) 

点击 ![1575444758298](图片/1575444758298.png) 设置跨域规则如下：

![1575444704748](图片/1575444704748.png) 
...
![1575442872330](图片/1575442872330.png) 

在跳转的页面中，选择用户，并新建一个用户： 

![1575443068711](图片/1575443068711.png) 

然后填写用户信息：

![1575443013764](图片/1575443013764.png) 

然后会为你生成用户的AccessKeyID和AccessKeySecret，下图马赛克部分：

![1575443194990](图片/1575443194990.png) 
...
![1575443396855](图片/1575443396855.png) 

点击添加权限，会进入权限选择页面，输入oss进行搜索，然后选择`管理对象存储服务（OSS）`权限： 

![1575443529053](图片/1575443529053.png) 
...
![1575445994148](图片/1575445994148.png) 

然后在弹出的新页面的左侧菜单中找到开发者指南：

![1575446106525](图片/1575446106525.png) 
...
![1575446365802](图片/1575446365802.png) 
...
![1575448077824](图片/1575448077824.png) 
...
![1552311833528](图片/1552311833528.png)
...
![1552314430650](图片/1552314430650.png)

所以我们只需要在`BrandForm`页面中，给`v-upload`组件，加上`need-signature`属性，并且指定一个获取签名的url地址即可：

![1552314746644](图片/1552314746644.png)

自定义的上传组件中的核心代码：

![1552315238995](图片/1552315238995.png)
...
![1552315014021](图片/1552315014021.png)
...
![1575449278319](图片/1575449278319.png) 
...
![1575454168088](图片/1575454168088.png) 
...
![1575454842821](图片/1575454842821.png) 
...
![1575455655488](图片/1575455655488.png) 

一款空调的属性：

![1575455706369](图片/1575455706369.png) 
...
![1526087142454](图片/1526087142454.png) 
...
![1534634716761](图片/1534634716761.png) 
...
![1534636185452](图片/1534636185452.png)
...
​	 ![1534636623281](图片/1534636623281.png)
...
![1526090072535](图片/1526090072535.png)

你会发现，过滤条件中的屏幕尺寸、运行内存、网路、机身内存、电池容量、CPU核数等，在规格参数中都能找到：

 ![1526090228171](图片/1526090228171.png)
...
![1575532225534](图片/1575532225534.png) 

打开规格参数页面，可以看到页面发生了变化，看到如下内容：

![1552659142800](图片/1552659142800.png)
...
![1552488184332](图片/1552488184332.png)
...
![1552661146177](图片/1552661146177.png)
...
![1575536583343](图片/1575536583343.png) 
...
![1575536304029](图片/1575536304029.png) 
...
![1578395494883](图片/1578395494883.png) 
...
![1575541404707](图片/1575541404707.png) 
...
![1575541550179](图片/1575541550179.png) 
...
![1575542328030](图片/1575542328030.png) 

找到如下说明：

![1575542361503](图片/1575542361503.png) 
...
![1575541714644](图片/1575541714644.png) 

在页面刷新：

![1575541783067](图片/1575541783067.png) 

控制台输出的sql：

发现已经加入了反引号处理：

![1575542458197](图片/1575542458197.png) 
...
![1578459826100](图片/1578459826100.png) 
