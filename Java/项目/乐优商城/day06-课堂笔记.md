...
![1528874711108](图片/1528874711108.png) 

点击这个按钮，并没有打开商品编辑窗口，而是弹出了一个提示窗口：

![1552901853155](图片/1552901853155.png)
...
![1552902179096](图片/1552902179096.png)
...
![1552914451933](图片/1552914451933.png)
...
![1575797061845](图片/1575797061845.png) 
...
![1552915043070](图片/1552915043070.png)

接口文档：

![1575797093977](图片/1575797093977.png) 
...
![1528875639346](图片/1528875639346.png) 
...
![1552916650110](图片/1552916650110.png)

区别在于，这次的请求中带上了id信息，因为需要根据id来修改数据

包括spuDetail也是一样：

![1552916682788](图片/1552916682788.png)

但是再来看sku：

![1552916705801](图片/1552916705801.png)
...
![1575856639891](图片/1575856639891.png) 

解压缩：

![1575856696888](图片/1575856696888.png) 

然后通过idea打开，可以看到项目结构：

![1575856847088](图片/1575856847088.png) 
...
![1575857010863](图片/1575857010863.png) 
...
![1575857312796](图片/1575857312796.png) 
...
![1575857694357](图片/1575857694357.png) 



第二步，修改nginx配置，将www.leyou.com反向代理到127.0.0.1:9002

![1575857827272](图片/1575857827272.png) 

如果之前没有配置，现在需要按照上面步骤配置，配置完成后需要重新加载nginx配置：

`nginx.exe -s reload`

![1575857973549](图片/1575857973549.png) 
...
![1575858309929](图片/1575858309929.png) 



- 首先对axios进行了一些全局配置，请求超时时间，请求的基础路径，是否允许跨域操作cookie等

  ![1575858773458](图片/1575858773458.png) 

- 定义了对象 ly ，也叫leyou，包含了下面的属性：

  - getUrlParam(key)：获取url路径中的参数

    ![1575858701582](图片/1575858701582.png) 
  ...
  - formatPrice：格式化价格，如果传入的是字符串，则扩大100被并转为数字，如果传入是数字，则缩小100倍并转为字符串
    ...
    ![1575858879276](图片/1575858879276.png) 

  - formatDate(val, pattern)：对日期对象val按照指定的pattern模板进行格式化

    ![1575858925601](图片/1575858925601.png) 

  - stringify：将对象转为参数字符串

  - parse：将参数字符串变为js对象

    ![1575859566989](图片/1575859566989.png) 



  - 解构表达式

    ![1575860041644](图片/1575860041644.png) 
...
![1575862471312](图片/1575862471312.png)  
...
![1575873023690](图片/1575873023690.png) 



![1575873060134](图片/1575873060134.png)
...
![1575973786265](图片/1575973786265.png) 
...
![1575876595669](图片/1575876595669.png) 

### 2）安装head插件

![1575974029838](图片/1575974029838.png) 

head插件有安装版、tomcat版和chrome的插件版，我们采用插件版即可。

### 3）安装kibana

![1575974208240](图片/1575974208240.png) 
...
![1575878066949](图片/1575878066949.png) 
...
![1526607357743](图片/1526607357743.png)
...
先来看看页面中直观看到有什么数据，这些数据就是用来渲染的数据：
 ...
 ![1526607712207](图片/1526607712207.png) 
...
![1526608095471](图片/1526608095471.png)

这些过滤条件也都需要存储到索引库中，包括：商品分类、品牌、可用来搜索的规格参数

另外还有需要排序的字段：

![1552989729067](图片/1552989729067.png) 
...
![1576032495824](图片/1576032495824.png) 

测试：

![1576033154083](图片/1576033154083.png) 
...
![1576033238112](图片/1576033238112.png) 
...
![1576026808540](图片/1576026808540.png) 
...
![1576035892780](图片/1576035892780.png) 
...
![1576036391645](图片/1576036391645.png) 
